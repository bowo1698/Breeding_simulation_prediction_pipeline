...
# Impute missing values in TEST Gen 12
...
# Impute missing values in TEST Gen 13
...
# 2.1 Genomic Relationship Matrix (GRM) for GBLUP
...
# 2.3 Create 5-fold CV indices for ML models
set.seed(123)
...
svr_model <- svm(
  ...
  cost = 1, # svr_grid$cost[best_svr],
  epsilon = 0.1 # svr_grid$epsilon[best_svr]
)
})
